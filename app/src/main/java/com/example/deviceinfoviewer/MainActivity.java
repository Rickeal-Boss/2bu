            ...
            switch (DIAG_STEP) {
                ...
                case 3:
                    ...
                    new TabLayoutMediator(tabLayout, viewPager,
                            (tab, p) -> tab.setText(SafePagerAdapter.getTabTitle(p))).attach();
                    break;
                case 31:
                    ...
                    new TabLayoutMediator(tabLayout, viewPager,
                            (tab, p) -> tab.setText(SafePagerAdapter.getTabTitle(p))).attach();
                    break;
                case 32: setContentView(R.layout.activity_step3b); break;
                case 33:
                ...
                case 35:
                    ...
                    break;
                case 36:
                    // TabLayout+ViewPager2 布局，只 setAdapter，不碰 TabLayout
                    setContentView(R.layout.activity_step3a);
                    viewPager = findViewById(R.id.view_pager);
                    viewPager.setAdapter(new SafePagerAdapter(this));
                    break;
                case 37:
                    ...
                    break;
                case 38:
                    // + addTab + TabLayout listener（无 ViewPager callback）
                    setContentView(R.layout.activity_step3a);
                    viewPager = findViewById(R.id.view_pager);
                    tabLayout = findViewById(R.id.tab_layout);
                    viewPager.setAdapter(new SafePagerAdapter(this));
